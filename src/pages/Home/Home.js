  ...
  return (
    <div className={s.container}>
      <Carousel
        ...
        useKeyboardArrows
      >
        {/*header_1(pin):"100% готові, високоякісні та надійні вебсайти для стоматологій"*/}
        {/*header_2(pin):"Стильний, сучасний та високоякісний вебсайт Вашої стоматології від 5 хвилин"*/}
        {/*header_text_1(pin):"Найпростіший спосіб створити, запустити та розвивати Ваш бізнес"*/}
        {/*header_text_2(pin):"Простота у налаштуванні - гнучкість - швидкий старт"*/}
        {/*header_text_3(pin):"Запустіть свій веб-сайт менш ніж за пів години!"*/}
        {/*header_3*/}
        {[...Array(3)].map((_, i) => (
